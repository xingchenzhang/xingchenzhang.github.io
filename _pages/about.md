...
At FIL, we aim to **develop machine intelligence and information fusion technologies for human benefit**, with a particular focus on multimodal perception, embodied intelligence, and trustworthy AI, as well as applications in areas such as healthcare. Our research has received funding and support from various sources, including the **Royal Society**, the **Marie Skłodowska-Curie Actions** programme, **NVIDIA**, **UKRI AIRR**, and global partnership funding from the University of Exeter.
